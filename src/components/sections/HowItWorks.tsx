...
const STEPS = [
  ...
  },
  {
    ...
    description: (
      <>
        Open the <strong className="font-semibold text-white/90">Access Purchase</strong> email and go to your{" "}
        <a
...
export default function HowItWorks() {
  ...
  return (
    <section ref={ref} className="border-t border-white/[0.06] bg-black px-4 py-16 sm:px-6 sm:py-24">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative">
          ...
          {STEPS.map((step, i) => (
            ...
            >
              <span className="relative flex h-8 w-8 items-center justify-center rounded-full border border-white/25 bg-black text-sm font-semibold text-white">
                {i + 1}
              </span>
