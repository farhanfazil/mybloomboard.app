    ...
    featureGroups: [
      {
        ...
        items: [
          ...
          { text: "Boards - up to 5", included: true },
    ...
    featureGroups: [
      {
        ...
        items: [
          ...
          { text: "Due date & priority tracking", included: true },
          { text: "Reminders & meeting alerts", included: true },
          { text: "Boards - up to 10, create several at once", included: true },
    ...
    featureGroups: [
      {
        ...
        items: [
          ...
          { text: "Due date & priority tracking", included: true },
          { text: "Reminders & meeting alerts", included: true },
          { text: "Boards - unlimited, create several at once", included: true },
          { text: "Bloom AI Task Automation", included: true },
        ],
      },
      {
    ...
    featureGroups: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Reminders & meeting alerts", included: true },
          { text: "Boards - unlimited, shared, create several at once", included: true },
          { text: "Bloom AI Task Automation", included: true },
        ],
      },
      {
